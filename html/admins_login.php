  ...
  <div class="wrapper">
    ...
    font-size: 30px;">|</b>
      ...
      <div class="input_box">
        ...
        <input class="input_box2" type="email" name="email" placeholder="Email" style="font-size: 18px;" required>
      ...
      <div class="input_box">
        ...
        <input class="input_box2" type="password" name="password" placeholder="Password " style="font-size: 18px;"
          required>
        <br><br>
      </div>
