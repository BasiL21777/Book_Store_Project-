...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errorFields)) {
        ...
        // Insertion query
        $query = "INSERT INTO `users` (name, email, password,role) VALUES ('$name', '$email', '$password','C')";
...
<body>
    ...
    font-size: 30px;">|</b>
            ...
            <div class="input_box">
                ...
                <input class="input_box2" type="text" name="Name" placeholder="User Name " style="font-size: 18px;"
            ...
            <div class="input_box">
                ...
                <?php
                if (!empty($error)) {
                    echo "<p style='color:orangered'>This Email Already Used</p> ";
                }
                ?>
            </div>
            ...
            <div class="input_box">
                ...
                <input class="input_box2" type="password" name="PassWord" placeholder="Password " required minlength="5"
                    style="font-size: 18px;" id="PassWord" maxlength="10">
                <?php if (in_array('Password', $error_Fields))
                    echo "*Please enter the Password more than 5 chars"; ?>
                <br>
            </div>

            <div class="input_box">
                <i class='bx bxs-lock-alt'></i>
                <input class="input_box2" type="password" name="ConfirmPassWord" placeholder="Confirm Password "
                    required minlength="1" style="font-size: 18px;" id="ConfirmPassWord" maxlength="10">
